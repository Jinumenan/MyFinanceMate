...
const IncomePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('http://localhost:3003/api/transactions', { // Change port to 3003
        ...formData,
        amount: amount,
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
      <h1 className="text-2xl font-bold mb-6 text-center text-green-600">Add Income</h1>
